<template>
  ...
  <div class="text-center bg-slate-100  flex flex-col  items-center">
    ...
    <TheCircle class="ml-[100px]">
      <img 
      src="https://duet-cdn.vox-cdn.com/thumbor/0x0:1000x1000/828x828/filters:focal(500x500:501x501):no_upscale():format(webp)/cdn.vox-cdn.com/uploads/chorus_asset/file/13624089/duolingo_2.gif"
      alt="duo">
    </TheCircle>
